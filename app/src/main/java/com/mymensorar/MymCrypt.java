...
public class MymCrypt {
    ...
    private static byte[] encryptOrDecrypt(
        ...
        try {
            ...
            throw new RuntimeException("MymCrypt encdrcrypt Exception!!!! while " + (isEncrypt ? "ENCRYPTING" : "DECRYPTING"), e);
        }
    }
    ...
    public static SecretKey getSecretKeySecurely(String password, SharedPreferences sharedPref) {
        ...
        try {
            ...
            throw new RuntimeException("MymCrypt getseckry Exception!!!!", e);
        }
    }
